...
/// If set to YES, you will be able to interact with a single data point.
@property (nonatomic) BOOL singleDataPointInteractionMode;
...
- (nonnull NSString *)lineGraph:(nonnull BEMSimpleLineGraphView *)graph labelOnXAxisForIndex:(NSInteger)index;
